<h1 align="center">Welcome to Facebook Auth Component with React and Firebase 👋</h1>
<p>
...
> Experiment using bit for create simple facebook login with Firebase and React

## Install

```sh
npm i @bit/krissnawat.firebaseauth.facebook-auth
```
